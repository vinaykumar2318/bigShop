  ...
  return (
    <div className='flex flex-col items-center justify-center h-screen'>
      ...
      <div className="w-3/5 h-2/5">
        <Link href={'/'} className="text-white py-2 rounded-full font-bold flex justify-center items-center bg-[#0C82E7] text-lg transition-transform hover:scale-105 h-64">
