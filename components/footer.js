...
const Footer = () => {
  return (
    <div>
      <footer className="text-gray-600 body-font bg-[#B7D5E2]">
        <div className="container px-5 py-24 mx-auto flex md:items-center lg:items-start md:flex-row md:flex-nowrap flex-wrap flex-col" style={{ maxWidth: '1200px' }}>
          ...
          <div className="flex-grow flex flex-wrap md:pl-20 -mb-10 md:mt-0 mt-10 md:text-left text-center">
            <div className="lg:w-1/4 md:w-1/2 w-full px-4">
              ...
              <nav className="list-none mb-10">
                ...
                <li>
                  <a className="text-gray-600 hover:text-gray-800">Home & Kitchen</a>
                </li>
                <li>
                  <a className="text-gray-600 hover:text-gray-800">Beauty Products</a>
                </li>
              </nav>
            </div>
            <div className="lg:w-1/4 md:w-1/2 w-full px-4">
              ...
              <nav className="list-none mb-10">
                ...
                <li>
                  <a className="text-gray-600 hover:text-gray-800">Returns & Refunds</a>
                </li>
                <li>
                  <a className="text-gray-600 hover:text-gray-800">Shipping Information</a>
                </li>
                <li>
        ...
        <div className="bg-gray-100">
          <div className="container mx-auto py-4 px-5 flex flex-wrap flex-col sm:flex-row">
            <p className="text-gray-500 text-sm text-center sm:text-left">© 2024 BigShop —
              <a href="https://github.com/vinaykumar2318/" rel="noopener noreferrer" className="text-gray-600 ml-1" target="_blank">@vinaykumar</a>
            </p>
